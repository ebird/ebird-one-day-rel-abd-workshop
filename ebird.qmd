...
f_sed <- "data/ebd_BR-RS_fotfly_smp_relJun-2023_sampling.txt" # TODO
...
f_ebd <- "data/ebd_BR-RS_fotfly_smp_relJun-2023.txt" # TODO
...
checklists_unique %>% 
  filter(checklist_id == "G10019405") %>% # TODO
...
observations %>% 
  filter(sampling_event_identifier == "S99335111") %>% # TODO
