...
1. Create a script named "ebird-data.R", visit [this link](https://raw.githubusercontent.com/ebird/ebirdst-one-day-rel-abd-workshop/main/scripts/ebird-data.R), and copy the contents into the script you just created.
2. Create a script named "ebird-rel-abd.R", visit [this link](https://raw.githubusercontent.com/ebird/ebirdst-one-day-rel-abd-workshop/main/scripts/ebird-rel-abd.R), and copy the contents into the script you just created.
